...
class ActionType(Enum):
    """
    Poker action types for analysis modules.
    
    Values MUST match poker_env.actions.ActionType values exactly.
    Member names differ for brevity (CHECK_CALL vs CHECK_OR_CALL).
    """
    FOLD = "FOLD"
