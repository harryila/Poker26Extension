...
- Tagged residuals: `results/direction_probe/qwen8b_l23/raw_residuals_tagged.npz`  (rows with oracle: 685)
...
| medium_pairs | +0.067 |
| small_pairs | +0.609 |
| premium_broadway | +0.426 |
| strong_broadway | +0.496 |
| medium_broadway | +0.447 |
| suited_aces | +0.377 |
| suited_connectors | +0.459 |
| suited_gappers | +0.458 |
| offsuit_connectors | -0.117 |
| weak_broadway | +0.178 |
| speculative_suited | +0.301 |
| trash | +0.486 |

- **trash-mass decodability R^2 = +0.486**  (mean over buckets +0.347)
...
- PROBE-recovered trash from the residual: mean **0.666**  (|err| 0.027)
